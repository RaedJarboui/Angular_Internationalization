...
@Component({
  ...
  styleUrls: [
    ...
    "./translate-udf.component.css",
  ],
})
export class TranslateUdfComponent implements OnInit, AfterViewInit {
  value = "";
  keyboard: Keyboard;
  keyboardLayouts: any;
  ...
  ngOnInit(): void {
    console.log("fieldName value ngOniti :", this.variablesGlobales.fieldName);
  ...
  handlePageChange(event) {
    ...
    this.translationService
      .findListAcmUDF(this.variablesGlobales.ID_UDF_LIST_VALUE)
      .subscribe((data) => {
        //console.log(data)
  ...
  addTranslation(i) {
    ...
    this.column_index = this.list_columns.indexOf(
      this.variablesGlobales.column
    );
