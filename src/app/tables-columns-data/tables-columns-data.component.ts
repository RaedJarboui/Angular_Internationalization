...
export class TablesColumnsDataComponent implements OnInit,AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    console.log("fieldName value ngAfterViewInit :",this.variablesGlobales.fieldName)
  ...
  ngAfterViewInit() {
    ...
    (k = this.keyboard), setTimeout(() => {}, 3000)
    ;
  }
...
ngOnDestroy() {
  ...
  retrieveTranslation() {
    for (var i = 0; i < this.global_langues.length; i++) {
      this.col.push(
        ...
        {
          field: this.global_langues[i].locale,
          header: this.global_langues[i].locale,
        },
    ...
    if (this.boolValue == false) {
      ...
      this.translationService
        ...
        .subscribe(
          (data) => {
            ...
            this.missing_lang = this.missing_lang.filter((item) =>
      ...
      this.translationService
        ...
        .subscribe((data) => {
          ...
          this.eventService
            .getTableData(this.selected_table)
            .subscribe((data) => {
              this.tables = data;
            });
        });
  ...
  handlePageChange(event) {
    ...
    if (event.multiSortMeta && isEmpty) {
      ...
      let object = {
        ...
        pageSize: event.rows,
        sortDirection: event.multiSortMeta[0].order.toString(),
        ...
        this.translationService
          ...
          .subscribe((data) => {
            ...
            if (this.ascending.length > 0) {
              this.array_string = this.ascending.slice(
                (currentPage - 1) * this.pageSize,
                currentPage * this.pageSize
              );
            } else if (this.descending.length > 0) {
              this.array_string = this.descending.slice(
                (currentPage - 1) * this.pageSize,
                currentPage * this.pageSize
              );
            }
      ...
      this.translationService.getSortedTranslation(object).subscribe((data) => {
        ...
        const result = this.ArrayString.filter((v) =>
          v.includes(event.filters[this.filterField].value)
        );

        if (
          this.array_string.length == 0 &&
          this.ArrayString.filter((v) =>
            v.includes(event.filters[this.filterField].value)
          )
        ) {
          ...
          if (data.sortDirection == -1) {
            this.descending = this.array_string.sort((a, b) =>
              a > b ? -1 : 1
            );
            //console.log("descending",this.descending)
          } else if (data.sortDirection == -1) {
              ...
              this.translationService
                ...
                .subscribe((data) => {
                  ...
                  if (
                    ...
                    this.array_string = this.array_string.slice(
                      (currentPage - 1) * this.pageSize,
                      currentPage * this.pageSize
                    );
                    //console.log("array string true found : ", this.array_string)
                    if (this.array_string.length > 0) this.loading = false;
                  }
                });
            }
            //  else if(this.descending.length>0){
  ...
  handlePageChangee(event) {
    ...
    if (event.multiSortMeta && isEmpty) {
      ...
      this.translationService.getSortedTranslation(object).subscribe((data) => {
        ...
        this.translationService
          ...
          .subscribe((data) => {
            ...
            //console.log("ascending slice :",this.ascending.slice((currentPage - 1) * this.pageSize, currentPage * this.pageSize))
            if (this.ascending.length > 0) {
              this.select2_array = this.ascending.slice(
                (currentPage - 1) * this.pageSize,
                currentPage * this.pageSize
              );
            } else if (this.descending.length > 0) {
              this.select2_array = this.descending.slice(
                (currentPage - 1) * this.pageSize,
                currentPage * this.pageSize
              );
            }
      ...
      this.translationService.getSortedTranslation(object).subscribe((data) => {
        ...
        const result = this.ArrayString1.filter((v) =>
          v.includes(event.filters[this.filterField].value)
        );

        if (
          this.ArrayString1.filter((v) =>
            v.includes(event.filters[this.filterField].value)
          )
        ) {
          this.select2_array = [];
          ...
          if (data.sortDirection == -1) {
            this.descending = this.select2_array.sort((a, b) =>
              a > b ? -1 : 1
            );
            //console.log("descending",this.descending)
          } else if (data.sortDirection == -1) {
            this.ascending = this.select2_array.sort((a, b) =>
              a > b ? 1 : -1
            );
            //console.log("ascending",this.ascending)
          }
              ...
              this.translationService
                ...
                .subscribe((data) => {
                  ...
                  if (
                    ...
                    this.select2_array = this.select2_array.slice(
                      (currentPage - 1) * this.pageSize,
                      currentPage * this.pageSize
                    );
  ...
  onSubmit(f: NgForm) {
    ...
    this.translationService
      .addEntity(this.selected_table, f.value)
      .subscribe((data) => {
        this.ngOnInit();
  ...
  select1(value) {
    ...
    //console.log(a);
    this.translationService
      .select1(this.selected_table, this.selected_column, this.IsJson, a)
      .subscribe((data) => {
        //console.log(data);
        ...
        for (var key in this.select_array[0].VALUE_JSON) {
          ...
          if (
            this.select_array[0].VALUE_JSON[key] == null ||
            this.select_array[0].VALUE_JSON[key] == "" ||
            this.select_array[0].VALUE_JSON[key] == true ||
            this.select_array[0].VALUE_JSON[key] == false ||
            Number.isInteger(this.select_array[0].VALUE_JSON[key])
          ) {
  ...
  onKeyUp(event, j) {
    ...
    if (inputValue.length > 0) {
      this.translationService
        .AutocompleteTranslation(this.global_langues[j].locale, inputValue)
        .subscribe((data) => {
  ...
  addTranslation(i) {
    ...
    if (this.add_edit == false) {
      ...
      this.eventService
        ...
        .subscribe(
          (data) => {
            ...
            this.toast.success(
              "I'm a toast!",
              "Translation edited succesfully!"
            );
          },
          (error) => {
            this.toast.error(
              "I'm a toast!",
              "Translation not edited succesfully!"
            );
          }
        );
    } else {
      ...
      this.eventService.addTranslation(object1).subscribe(
        (data) => {
          //console.log(data);
        ...
        (error) => {
          this.toast.error(
            "I'm a toast!",
            "Translation not added succesfully!"
          );
        }
      );
    }
  ...
  addTranslation1(i) {
    ...
    if (this.add_edit == false) {
      ...
      this.eventService.addTranslation(object4).subscribe(
        (data) => {
          //console.log(data);
          this.toast.success("I'm a toast!", "Translation added succesfully!");
        },
  ...
  udfValues(s) {
    ...
    var data = this.jsonArray.filter((obj, pos, arr) => {
      return (
        arr.map((mapObj) => mapObj.FIELD_NAME).indexOf(obj.FIELD_NAME) == pos
      );
    });
    ...
    this.variablesGlobales.ID_UDF_LIST_VALUE =
      ID_UDF_LIST_VALUE[0].ID_UDF_LIST_VALUE;
  ...
  onSelectChange = (event: any) => {
    ...
    console.log("onSelectChange keyboard", this.keyboard);
